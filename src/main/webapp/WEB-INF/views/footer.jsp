    ...
    <div id="errormessage" style="display: none"></div>
        <form id="loginform" name="loginform" method="get" action="createinsight.html">
             <p><span class="title"> <spring:message code="footer_message_login_username"/></span> <input type="text" name="username" class="login" id="username"></p>
                ...
                <p>
                <a href="#" onclick="lightbox_close();" class="cancel-btn fl font18"> <spring:message code="footer_message_button_cancel"/> </a>
                <input type="button" value="<spring:message code="footer_message_button_login"/>" name="" class="loginbtn fr font18" onclick="submitForm()"></p>
            </form>
