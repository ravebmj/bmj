...
/**
 * DTO for Geographies entity.
 * @author nilesh.kambli
 *
 */
public class GeographiesDto  implements Serializable,Comparable<GeographiesDto>{
	...
	@Override
	public int compareTo(GeographiesDto arg0) {
